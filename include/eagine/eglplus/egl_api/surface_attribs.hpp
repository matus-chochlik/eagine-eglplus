...
static constexpr auto operator|(
  surface_attribute key,
  egl_types::int_type value) noexcept -> surface_attribute_value {
    return {key, value};
}
...
static constexpr auto operator|(
  surface_attribute key,
  texture_format value) noexcept -> surface_attribute_value {
...
static constexpr auto operator|(
  surface_attribute key,
  texture_target value) noexcept -> surface_attribute_value {
    return {key, egl_types::int_type(value)};
}
...
static constexpr auto operator|(
  surface_attribute key,
  gl_colorspace value) noexcept -> surface_attribute_value {
    return {key, egl_types::int_type(value)};
}
