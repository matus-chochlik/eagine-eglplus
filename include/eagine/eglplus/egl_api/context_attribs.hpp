...
///
#ifndef EAGINE_EGLPLUS_EGL_API_CONTEXT_ATTRIBS_HPP
#define EAGINE_EGLPLUS_EGL_API_CONTEXT_ATTRIBS_HPP
...
static constexpr auto operator|(
  ...
  egl_types::int_type value) noexcept -> context_attribute_value {
    return {key, value};
}
